...
export default Component.extend({
  ...
  _onValidateBatch(files) {
    this.trigger('validateBatch', {
      files,
    });
  },

  _onProgress(id, name, loaded, total) {
